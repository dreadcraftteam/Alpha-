...
public abstract class Minecraft implements Runnable {
    ...
    public LoadingScreenRenderer loadingScreen = new LoadingScreenRenderer(
        this
    );
    ...
    public abstract void displayUnexpectedThrowable(
        UnexpectedThrowable unexpectedThrowable1
    );
    ...
    public void startGame() throws LWJGLException {
        ...
        this.renderEngine = new RenderEngine(this.options, this.texturePackList);
        ...
        try {
            this.downloadResourcesThread = new ThreadDownloadResources(
                this.mcDataDir,
                this
            );
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(
                new GuiConnecting(this, this.serverName, this.serverPort)
            );
        } else {
    ...
    private void loadScreen() throws LWJGLException {
        ScaledResolution scaledResolution1 = new ScaledResolution(
            this.displayWidth,
            this.displayHeight
        );
        ...
        GL11.glBindTexture(
            GL11.GL_TEXTURE_2D,
            this.renderEngine.getTexture("/title/mojang.png")
        );
        tessellator4.startDrawingQuads();
        tessellator4.setColorOpaque_I(0xFFFFFF);
        tessellator4.addVertexWithUV(
            0.0D,
            (double) this.displayHeight,
            0.0D,
            0.0D,
            0.0D
        );
        tessellator4.addVertexWithUV(
            (double) this.displayWidth,
            (double) this.displayHeight,
            0.0D,
            0.0D,
            0.0D
        ...
        this.scaledTessellator(
            (this.displayWidth / 2 - s5) / 2,
            (this.displayHeight / 2 - s6) / 2,
            0,
            0,
            s5,
            s6
    ...
    public void scaledTessellator(
        ...
        tessellator9.addVertexWithUV(
            (double) (i1 + 0),
            (double) (i2 + i6),
            0.0D,
            (double) ((float) (i3 + 0) * f7),
            (double) ((float) (i4 + i6) * f8)
        );
        tessellator9.addVertexWithUV(
            (double) (i1 + i5),
            (double) (i2 + i6),
            0.0D,
            (double) ((float) (i3 + i5) * f7),
            (double) ((float) (i4 + i6) * f8)
        );
        tessellator9.addVertexWithUV(
            (double) (i1 + i5),
    ...
    public static File getAppDir(String string0) {
        ...
        switch (OSMap.osValues[getOs().ordinal()]) {
            ...
            case 4:
                file2 = new File(
                    string1,
                    "Library/Application Support/" + string0
                );
                break;
            default:
                file2 = new File(string1, string0 + '/');
        ...
        if (!file2.exists() && !file2.mkdirs()) {
            throw new RuntimeException(
                "The working directory could not be created: " + file2
            );
        } else {
            return file2;
        }
    ...
    private static EnumOS getOs() {
        ...
        return string0.contains("win")
            ? EnumOS.windows
            : (string0.contains("mac")
                    ? EnumOS.macos
                    : (string0.contains("solaris")
                            ? EnumOS.solaris
                            : (string0.contains("sunos")
                                    ? EnumOS.solaris
                                    : (string0.contains("linux")
                                            ? EnumOS.linux
                                            : (string0.contains("unix")
                                                    ? EnumOS.linux
                                                    : EnumOS.unknown)))));
    }
    ...
    public void displayGuiScreen(GuiScreen guiScreen1) {
        if (!(this.currentScreen instanceof GuiErrorScreen)) {
            ...
            if (guiScreen1 != null) {
                ...
                ScaledResolution scaledResolution2 = new ScaledResolution(
                    this.displayWidth,
                    this.displayHeight
                );
    ...
    public void run() {
        ...
        try {
            ...
            this.displayUnexpectedThrowable(
                new UnexpectedThrowable("Failed to start game", exception13)
            );
            return;
        }
        ...
        try {
            ...
            while (
                this.running &&
                (this.mcApplet == null || this.mcApplet.isActive())
            ) {
                ...
                if (!this.skipRenderWorld) {
                    if (this.playerController != null) {
                        this.playerController.setPartialTime(
                            this.timer.renderPartialTicks
                        );
                    }
                ...
                if (
                    this.mcCanvas != null &&
                    !this.fullscreen &&
                    (this.mcCanvas.getWidth() != this.displayWidth ||
                ...
                for (
                    this.isGamePaused =
                        !this.isMultiplayerWorld() &&
                        this.currentScreen != null &&
                        this.currentScreen.doesGuiPauseGame();
                    System.currentTimeMillis() >= j1 + 1000L;
                    i3 = 0
                ) {
                    this.debug =
                        i3 +
        ...
        } catch (MinecraftError minecraftError14) {} catch (
            Throwable throwable15
        ) {
            this.theWorld = null;
            throwable15.printStackTrace();
            this.displayUnexpectedThrowable(
                new UnexpectedThrowable("Unexpected error", throwable15)
            );
        } finally {
    ...
    private void displayDebugInfo() {
        ...
        frameTimes[numRecordedFrameTimes++ & (frameTimes.length - 1)] =
            j1 - this.prevFrameTime;
        ...
        tessellator3.addVertex(
            (double) frameTimes.length,
            (double) this.displayHeight,
            0.0D
        );
        tessellator3.addVertex(
            (double) frameTimes.length,
            (double) (this.displayHeight - 100),
            0.0D
        );
        tessellator3.draw();
        long j4 = 0L;
        ...
        for (int i7 = 0; i7 < frameTimes.length; ++i7) {
            int i8 =
                (((i7 - numRecordedFrameTimes) & (frameTimes.length - 1)) *
                    255) /
                frameTimes.length;
            int i9 = (i8 * i8) / 255;
            i9 = (i9 * i9) / 255;
            int i10 = (i9 * i9) / 255;
            i10 = (i10 * i10) / 255;
            tessellator3.setColorOpaque_I(
                0xFF000000 + i10 + i9 * 256 + i8 * 65536
            );
            long j11 = frameTimes[i7] / 200000L;
            tessellator3.addVertex(
                (double) ((float) i7 + 0.5F),
                (double) ((float) ((long) this.displayHeight - j11) + 0.5F),
                0.0D
            );
            tessellator3.addVertex(
                (double) ((float) i7 + 0.5F),
                (double) ((float) this.displayHeight + 0.5F),
                0.0D
            );
        }
    ...
    private void clickMouse(int button) {
        if (button != 0 || this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                if (
                    button == 0 &&
                    !(this.playerController instanceof PlayerControllerCreative)
                ) {
                ...
                if (button == 1) {
                    this.thePlayer.interactWithEntity(
                ...
                Block block6 = Block
                    .blocksList[this.theWorld.getBlockId(i2, i3, i4)];
                if (button == 0) {
                    this.theWorld.extinguishFire(
                        i2,
                        i3,
                        i4,
                        this.objectMouseOver.sideHit
                    ...
                    if (
                        block6 != Block.bedrock ||
                        this.thePlayer.unusedMiningCooldown >= 100
                    ) {
                    ...
                    ItemStack itemStack7 =
                        this.thePlayer.inventory.getCurrentItem();
                    ...
                    if (itemStack7.stackSize == 0) {
                        this.thePlayer.inventory.mainInventory[this.thePlayer.inventory.currentItem] =
                            null;
            ...
            if (button == 1) {
                ...
                if (itemStack9 != null) {
                    ...
                    ItemStack itemStack10 = itemStack9.useItemRightClick(
                        this.theWorld,
                        this.thePlayer
                    );
                    if (
                        itemStack10 != itemStack9 ||
                        (itemStack10 != null && itemStack10.stackSize != i3)
                    ) {
                        this.thePlayer.inventory.mainInventory[this.thePlayer.inventory.currentItem] =
                            itemStack10;
    ...
    private void resize(int width, int height) {
        ...
        this.displayHeight = height;
        if (this.currentScreen != null) {
            ScaledResolution scaledResolution3 = new ScaledResolution(
                width,
                height
            );
    ...
    private void clickMiddleMouseButton() {
        if (this.objectMouseOver != null) {
            int i1 = this.theWorld.getBlockId(
                this.objectMouseOver.blockX,
                this.objectMouseOver.blockY,
            ...
            this.thePlayer.inventory.setCurrentItem(
                i1,
                this.playerController instanceof PlayerControllerCreative
            );
        }
                                    ...
                                    while (true) {
                                        ...
                                        if (
                                            ...
                                            if (this.currentScreen != null) {
                                                ...
                                                if (
                                                    Keyboard.getEventKey() ==
                                                    this.options.keyBindInventory.keyCode
                                                ) {
                                                    this.displayGuiScreen(
                                                        new GuiInventory(
                                                            this.thePlayer.inventory,
                                                            this.thePlayer.inventory.craftingInventory
                                                        )
                                                    );
                                                }
                                                ...
                                                if (
                                                    Keyboard.getEventKey() ==
                                                    this.options.keyBindDrop.keyCode
                                                ) {
                                                    this.thePlayer.dropPlayerItemWithRandomChoice(
                                                        this.thePlayer.inventory.decrStackSize(
                                                ...
                                                if (
                                                    this.isMultiplayerWorld() &&
                                                    Keyboard.getEventKey() ==
                                                    this.options.keyBindChat.keyCode
                                                ) {
                                                    this.displayGuiScreen(
                                                        new GuiChat()
                                                    );
                                            ...
                                            if (
                                                Keyboard.getEventKey() ==
                                                this.options.keyBindToggleFog.keyCode
                                            ) {
                                                this.options.setOptionValue(
                                                    4,
                                                    !Keyboard.isKeyDown(
                                                            Keyboard.KEY_LSHIFT
                                                        ) &&
    ...
    public void startWorld(String worldName) {
        ...
        World world2 = new World(
            new File(getMinecraftDir(), "saves"),
            worldName
        );
    ...
    public void changeWorld(World world, String title) {
        ...
        if (world != null) {
            ...
            if (!this.isMultiplayerWorld()) {
                this.thePlayer = (EntityPlayerSP) world.createDebugPlayer(
            ...
            if (this.thePlayer == null) {
                this.thePlayer =
                    (EntityPlayerSP) this.playerController.createPlayer(world);
                this.thePlayer.preparePlayerToSpawn();
    ...
    public String debugInfoEntities() {
        return (
            ...
            ". T: " +
            this.theWorld.getDebugLoadedEntities()
        );
    }
    ...
    public void respawn() {
        ...
        this.thePlayer = (EntityPlayerSP) this.playerController.createPlayer(
            this.theWorld
        );
        this.thePlayer.preparePlayerToSpawn();
        this.playerController.flipPlayer(this.thePlayer);
    ...
    public static void startMainThread(
        ...
        MinecraftImpl minecraftImpl7 = new MinecraftImpl(
            frame5,
            canvas6,
        ...
        if (username != null && sessionId != null) {
            ...
            minecraftImpl7.session = new Session(
        ...
        frame5.addWindowListener(
            new GameWindowListener(minecraftImpl7, thread8)
        );
        thread8.start();
    }
