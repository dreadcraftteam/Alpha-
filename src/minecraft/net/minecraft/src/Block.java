...
public class Block {
	...
	public static final Block clothRed = (new Block(21, 144, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothOrange = (new Block(22, 145, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothYellow = (new Block(23, 146, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothChartreuse = (new Block(24, 147, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothGreen = (new Block(25, 148, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothSpringGreen = (new Block(26, 149, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothCyan = (new Block(27, 150, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothCapri = (new Block(28, 151, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothUltramarine = (new Block(29, 152, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothViolet = (new Block(30, 153, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothPurple = (new Block(31, 154, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothMagenta = (new Block(32, 155, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothRose = (new Block(33, 156, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothDarkGray = (new Block(34, 157, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothGray = (new Block(35, 158, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothWhite = (new Block(36, 159, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
