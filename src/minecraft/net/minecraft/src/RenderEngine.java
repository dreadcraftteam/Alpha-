...
public class RenderEngine {
    ...
    public RenderEngine(
        GameSettings gameSettings1,
        TexturePackList texturePackList
    ) {
        this.options = gameSettings1;
        this.texturePackList = texturePackList;
    }
    ...
    public int getTexture(String string1) {
        ...
        if (integer2 != null) {
            ...
            try {
                ...
                if (inputStream == null) {
                    System.err.println("Texture not found: " + string1);
            ...
            for (i7 = 1; i7 <= 4; ++i7) {
                ...
                for (i11 = 0; i11 < i9; ++i11) {
                    for (i12 = 0; i12 < i10; ++i12) {
                        i13 = this.imageData.getInt(
                            (i11 * 2 + 0 + (i12 * 2 + 0) * i8) * 4
                        );
                        i14 = this.imageData.getInt(
                            (i11 * 2 + 1 + (i12 * 2 + 0) * i8) * 4
                        );
                        int i15 = this.imageData.getInt(
                            (i11 * 2 + 1 + (i12 * 2 + 1) * i8) * 4
                        );
                        int i16 = this.imageData.getInt(
                            (i11 * 2 + 0 + (i12 * 2 + 1) * i8) * 4
                        );
                        int i17 = this.alphaBlend(
                            this.alphaBlend(i13, i14),
                            this.alphaBlend(i15, i16)
                        );
    ...
    public int getTextureForDownloadableImage(String string1, String string2) {
        ThreadDownloadImageData threadDownloadImageData3 =
            (ThreadDownloadImageData) this.urlToImageDataMap.get(string1);
        if (
            threadDownloadImageData3 != null &&
            threadDownloadImageData3.image != null &&
            !threadDownloadImageData3.textureSetupComplete
        ) {
            if (threadDownloadImageData3.textureName < 0) {
                threadDownloadImageData3.textureName =
                    this.allocateAndSetupTexture(
                        threadDownloadImageData3.image
                    );
            } else {
                this.setupTexture(
                    threadDownloadImageData3.image,
        ...
        return threadDownloadImageData3 != null &&
            threadDownloadImageData3.textureName >= 0
            ? threadDownloadImageData3.textureName
            : this.getTexture(string2);
    }

    public ThreadDownloadImageData obtainImageData(
        String string1,
        ...
        if (threadDownloadImageData3 == null) {
            this.urlToImageDataMap.put(
                string1,
                new ThreadDownloadImageData(string1, imageBuffer2)
            );
        } else {
            ...
            for (i3 = 0; i3 < textureFX2.tileSize; ++i3) {
                for (i4 = 0; i4 < textureFX2.tileSize; ++i4) {
                    GL11.glTexSubImage2D(
                        GL11.GL_TEXTURE_2D,
                        0,
                        (textureFX2.iconIndex % 16) * 16 + i3 * 16,
                        (textureFX2.iconIndex / 16) * 16 + i4 * 16,
                        16,
                        16,
                        GL11.GL_RGBA,
                        GL11.GL_UNSIGNED_BYTE,
                    ...
                    if (useMipmaps) {
                        for (i5 = 1; i5 <= 4; ++i5) {
                            ...
                            for (i8 = 0; i8 < i7; ++i8) {
                                for (i9 = 0; i9 < i7; ++i9) {
                                    i10 = this.imageData.getInt(
                                        (i8 * 2 + 0 + (i9 * 2 + 0) * i6) * 4
                                    );
                                    i11 = this.imageData.getInt(
                                        (i8 * 2 + 1 + (i9 * 2 + 0) * i6) * 4
                                    );
                                    i12 = this.imageData.getInt(
                                        (i8 * 2 + 1 + (i9 * 2 + 1) * i6) * 4
                                    );
                                    int i13 = this.imageData.getInt(
                                        (i8 * 2 + 0 + (i9 * 2 + 1) * i6) * 4
                                    );
                                    int i14 = this.averageColor(
                                        this.averageColor(i10, i11),
                                        this.averageColor(i12, i13)
                                    );
                                    this.imageData.putInt(
                                        (i8 + i9 * i7) * 4,
                                        i14
                                    );
                                }
            ...
            if (textureFX2.textureId > 0) {
                ...
                if (useMipmaps) {
                    for (i3 = 1; i3 <= 4; ++i3) {
                        ...
                        for (i6 = 0; i6 < i5; ++i6) {
                            for (i7 = 0; i7 < i5; ++i7) {
                                i8 = this.imageData.getInt(
                                    (i6 * 2 + 0 + (i7 * 2 + 0) * i4) * 4
                                );
                                i9 = this.imageData.getInt(
                                    (i6 * 2 + 1 + (i7 * 2 + 0) * i4) * 4
                                );
                                i10 = this.imageData.getInt(
                                    (i6 * 2 + 1 + (i7 * 2 + 1) * i4) * 4
                                ...
                                i12 = this.averageColor(
                                    this.averageColor(i8, i9),
                                    this.averageColor(i10, i11)
                                );
    ...
    public void refreshTextures() {
        ...
        this.textureContentsMap.clear();

        Iterator iterator1 = this.textureMap.keySet().iterator();
        ...
        for (
            iterator1 = this.urlToImageDataMap.values().iterator();
            iterator1.hasNext();
            threadDownloadImageData6.textureSetupComplete = false
        ) {
            threadDownloadImageData6 =
                (ThreadDownloadImageData) iterator1.next();
        }
        ...
        while (iterator1.hasNext()) {
            ...
            try {
                if (string7.startsWith("##")) {
                    bufferedImage3 = this.unwrapImageByColumns(
                        ImageIO.read(
                            RenderEngine.class.getResourceAsStream(
                                string7.substring(2)
                            )
                        )
                    );
                    ...
                    bufferedImage3 = ImageIO.read(
                        RenderEngine.class.getResourceAsStream(string7)
                    );
                }
